...
def scqo_qubit_spectroscopy_cryoscope(
    ...
    start_drive_detuning_hz: float = -100000000.0,
    end_drive_detuning_hz: float = 100000000.0,
    num_drive_freq_points: int = 101,
    num_averages: int = 100,
    flux_pulse_amp_v: float = 0.1,
    drive_len_ns: float = 400.0,
    drive_shape: str = 'square',
    drive_sigma_frac: Annotated[float, (0.05, 0.5)] = 0.25,
    drive_amp_factor: float = 1.0,
    min_wait_ns: int = 16,
    ...
    return run_scqo(
        "qubit_spectroscopy_cryoscope",
        {
            ...
            "drive_sigma_frac": drive_sigma_frac,
            "drive_amp_factor": drive_amp_factor,
